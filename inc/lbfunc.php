...
function GetSBSSClientID($lb,$sbss,$agrm_id,$blibase){
	...
	while ($myrow2 = mysqli_fetch_array($result2)){
	    ...
	    $sql="update clients set group_id='$group_id',agrm_id='$agrm_id',billingid='$blibase' where id=$sbss_client_id";
	...
	switch ($blibase) {
	  ...
	  case 1:
		...
		case 1:
			...
			case 1 :$res=51;break; 		    // общие вопросы
			case 5 :$res=51;break; 		    // ТВ/Видео
			case 6 :$res=51;break; 		    // Интернет
	  ...
	  case 2:
		...
		case 1:	      
		    switch ($sbss_classes_ids) {
			case 1 :$res=61;break; 		    // общие вопросы
			case 5 :$res=61;break; 		    // ТВ/Видео
			case 6 :$res=61;break; 		    // Интернет
			case 7 :$res=8;break; 		    // Биллинг
			case 8 :$res=6;break; 		    // Жалобы
			default: $res=8;break; 		    // Не понятный запрос
		    };	      		    		    		    		    
