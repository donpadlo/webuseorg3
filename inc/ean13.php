...
$font_loc="../fonts/FreeSansBold.ttf";
...
function barcode_outhtml($code, $bars, $scale = 1, $total_y = 0, $space = ''){
    ...
    $out=
      ...
      '<tr><td><img src="fonts/white.png" height="'.$space['top'].'" width="1" alt=" "></td></tr>'."\n".
      '<tr><td>'."\n".
      '<img src="fonts/white.png" height="'.$height2.'" width="'.$space['left'].'" alt="#"/>';
	...
	if ($width){
	    $w=$val*$scale;
	    if ($w>0) $out.='<img src="fonts/white.png" height="'.$total_y.'" width="'.$w.'" align="top" alt="" />';
	    $width=false;
	    continue;
	}
	if (preg_match("#[a-z]#", $val)){
	...
	$w=$val*$scale;
	if ($w>0) $out.='<img src="fonts/black.png" height="'.$h.'" width="'.$w.'" align="top" />';
	$width=true;
    }
    $out.=
      '<img src="white.png" height="'.$height2.'" width=".'.$space['right'].'" />'.
      '</td></tr>'."\n".
      '<tr><td><img src="fonts/white.png" height="'.$space['bottom'].'" width="1"></td></tr>'."\n".
      '</table>'."\n";
