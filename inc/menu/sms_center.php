...
if ($md->IsActive("smscenter")==1) {     
    $this->Add("main","<i class='fa fa-commenting-o' aria-hidden='true'></i>","СМС-Центр","СМС-Центр",3,"smscenter","");
     ...
     $this->Add("smscenter","<i class='fa fa-comments-o' aria-hidden='true'></i>","<i class='fa fa-comments-o' aria-hidden='true'></i>Управление группами","Управление группами для отправки СМС",3,"smscenter/smsconfig","smscenter/sms");          
