...
<div class="container-fluid">
	<div class="row">
		...
		<form id="myForm" enctype="multipart/form-data"
			action="index.php?route=/controller/server/equipment/equipment_form.php?step=move&id=<?php echo "$id" ?>"
    ...
    ?>
						...
						<div class="checkbox">
							<label> <input type="checkbox" id=tmcgo name=tmcgo>ТМЦ в "пути"
							</label>
						</div>
					</div>
				</div>
