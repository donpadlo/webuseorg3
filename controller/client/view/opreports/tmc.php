...
while ($row = mssql_fetch_array($result)) {
    ...
    if (($sk != '') and ($it2 != 0) and ($cnt != 0)) {
        echo "<tr><td><strong>Всего по складу:</strong></td><td><strong>$it2</strong></td><td><strong>$deksk</strong></td></tr>";
        $it2 = 0;
        $deksk = 0;
    }
    ;
    ...
    // Склад
    if ($sk != "") {
        echo "<tr><td>$sk</td><td></td><td></td></tr>";
    }
    ;
    
    // Номенклатура
    if ($nm2 != "") {
        echo "<tr><td>$nm2</td><td></td><td></td></tr>";
    }
    ;
