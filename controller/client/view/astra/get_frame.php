...
<form id="myForm" class="well form-inline" ENCTYPE="multipart/form-data"
	action="controller/server/astra/astra_save_form.php?frame_id=<?php echo "$frame_id"; ?>"
	method="post" name="form1" target="_self">
	<label>Титры:</label></br>
	<textarea rows="3" class="form-control" name="tbody" id="tbody">
<?php echo "$tbody";?>
</textarea>
	</br> <span class="help-block">Время жизни фрейма:</span> <input
		class="span4" name="tframe" type="text" id="tframe"
		value="<?php echo "$tframe";?>">
	<div align=center>
...
<div id="userpic">
	...
	<div class="btn btn-success js-fileapi-wrapper">
		<div class="js-browse">
			<span class="btn-txt">Сменить фото jpg</span> <input type="file"
				name="filedata" />
		</div>
...
<div id="bt_muz_del" name="bt_muz_del"
	<?php if ($muz_file==""){echo 'style="visibility:hidden"';} else {echo 'style="visibility:visible"';} ?>>
	<button onclick="DelMuz()">Удалить</button>
</div>
<div align="center" id="simple-btn"
	class="btn btn-primary js-fileapi-wrapper">
	<div class="js-browse" align="center">
		<span class="btn-txt">Загрузить файл mp3/mp4/avi</span> <input
	...
	<div class="js-upload" style="display: none">
		...
		<span align="center" class="btn-txt">Загружаю (<span class="js-size"></span>)
		</span>
	</div>
</div>
