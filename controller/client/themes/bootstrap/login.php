...
{   
?>
   <link rel='stylesheet' type='text/css' href='controller/client/themes/<?php echo "$cfg->theme/css/upload.css";?>'>        
...
<div id="popup" class="popup" style="display: none;">
 ...
 <form class="form-horizontal" action="index.php?content_page=home&login_step=logout" method="post" name="form1" target="_self">
  <div class="form-group">
    <div class="controls">
      <button type="submit" class="form-control">Выйти из <?php echo "$user->login";?></button>
    </div>
  </div>     
 </form> 
</div>       
