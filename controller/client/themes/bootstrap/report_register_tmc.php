...
<div class="container-fluid">
    ...
    ?>
      <label>Помещение:</label></br>
		...
		<div class="col-xs-12 col-md-6 col-sm-6">
			<label>Период отчета:</label></br> <input name="dtstart" id="dtstart"
				size=16 value="" readonly> <input name="dtend" id="dtend" size=16
				value="" readonly> </br> <label>ТМЦ:</label></br>
			<div id="id_for_tmc"></div>
		</div>
		<button type="submit" class="form-control" id="viewwork"
			name="viewwork">Сформировать отчет</button>
		<button type="submit" class="form-control" id="prnt" name="prnt">Распечатать
			отчет</button>
	</div>
</div>
<div class="container-fluid">
	<div class="row-fluid" style="padding-right: 0px; padding-left: 0px;"
		id="if_for_report"></div>
</div>
<script type="text/javascript"
	src="controller/client/js/report_move_tmc.js"></script>