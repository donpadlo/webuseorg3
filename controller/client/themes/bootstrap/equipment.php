 ...
 * 10 = 'Админ с доступом в пределах организации'
 */
...
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12 col-md-12 col-sm-12" id="wequipment" >
			<select class="chosen-select" class="form-control" name="orgs"
				id="orgs">
<?php
    ...
    ?>
			...
			<div id="pg_nav"></div>
			<div id="pg_add_edit" style="padding-right: 0px; padding-left: 0px;"></div>
			<div class="row-fluid">
...
<?php else: ?>
<div class="alert alert-danger">У вас нет доступа в данный раздел! Не
	назначены роли!</div>
<?php endif; ?>
