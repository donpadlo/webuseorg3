...
<div class="content">
	<div class="row-fluid">
		<div id="calhead" style="padding-left: 1px; padding-right: 1px;">
			<div class="cHead">
				<div class="ftitle">Мой календарь</div>
				...
				<div id="errorpannel" class="ptogtitle loaderror"
					style="display: none;">Не могу загрузить данные. Попробуйте позже.</div>
			</div>

			<div id="caltoolbar" class="ctoolbar">
				<div id="faddbtn" class="fbutton">
					<div>
						<span title='Создать новую задачу' class="addcal">Новая задача</span>
					</div>
				</div>
				<div class="btnseparator"></div>
				<div id="showtodaybtn" class="fbutton">
					<div>
						<span title='Вернуться в сегодня ' class="showtoday">Сегодня</span>
					</div>
				</div>
				<div class="btnseparator"></div>
				...
				<div id="showdaybtn" class="fbutton">
					<div>
						<span title='День' class="showdayview">День</span>
					</div>
				</div>
				<div id="showweekbtn" class="fbutton fcurrent">
					<div>
						<span title='Неделя' class="showweekview">Неделя</span>
					</div>
				</div>
				<div id="showmonthbtn" class="fbutton">
					<div>
						<span title='Месяц' class="showmonthview">Месяц</span>
					</div>
				...
				<div id="showreflashbtn" class="fbutton">
					<div>
						<span title='Обновить просмотр' class="showdayflash">Обновить</span>
					</div>
				</div>
				<div class="btnseparator"></div>
				...
				<div class="fshowdatep fbutton">
					<div>
						<input type="hidden" name="txtshow" id="hdtxtshow" /> <span
							id="txtdatetimeshow">Выбрать дату</span>
