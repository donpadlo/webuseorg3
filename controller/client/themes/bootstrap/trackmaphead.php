...
<head>    
    ...
    <script type='text/javascript' src='controller/client/themes/<?php echo "$cfg->theme"; ?>/js/jquery-ui.js'></script>
    <link rel='stylesheet' type='text/css' href='controller/client/themes/<?php echo "$cfg->theme"; ?>/css/jquery-ui.min.css'>
    ...
    <link rel="stylesheet" href="controller/client/themes/<?php echo "$cfg->theme"; ?>/css/maps.css">    
