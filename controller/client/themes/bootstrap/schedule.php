...
<div id="schedule-dialog" title="Добавить/Изменить расписание">
	<div class="form-group">
		<label>Заголовок запроса</label> <input class="form-control"
			name="schedule-title" id="schedule-title"> <label>Работы ведутся</label><br />
		c: <input name="schedule_dtstart" id="schedule_dtstart" size=16
			value=""> по: <input name="schedule_dtend" id="schedule_dtend"
			size=16 value=""><br />
		<div class="checkbox">
			<label> <input type="checkbox" id="schedule-sms"> Запретить
				отправлять СМС и создавать уведомления
			</label> <label> <input type="checkbox" id="schedule-mail"> Запретить
				отправлять/принимать почту
			</label> <label> <input type="checkbox" id="schedule-message">
				Показывать пользователям сообщение
			</label>

		</div>
		<label>Комментарий к работам:</label>
		<textarea class="form-control" rows="3" name="schedule-comment"
			id="schedule-comment"></textarea>
	</div>
</div>
