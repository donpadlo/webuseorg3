		...
		<div class="col-xs-12 col-md-12 col-sm-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<textarea rows="13" class="col-xs-12 col-md-12 col-sm-12"
						name="htmlentry" id="htmlentry" placeholder="Текст сообщения"><?php echo "$htmlentry"?></textarea>
				</div>
			</div>
			<button class="form-control" type="button" onclick="SaveHtmlEntry();"
