...
if ($user->mode==1){
?>
<link rel='stylesheet' type='text/css' href='controller/client/themes/bootstrap/css/upload.css'>
...
<div class="row-fluid">
    <div class="well">  
        <div id="simple-btn" class="btn btn-success js-fileapi-wrapper">
            <div class="js-browse">
                <span class="btn-txt">Выберите файл</span>
            ...
            <span class="btn-txt">Загружаю.. (<span class="js-size"></span>)</span>
            </div>
        </div>
    </div>  
...
<script type="text/javascript" src="controller/client/js/lanbilling/smsstat.js"></script>
