		...
		<div class="col-xs-12 col-md-12 col-sm-12">
			...
			<div id="dialog-confirm" title="Разослать СМС по списку?">
				<span class="ui-icon ui-icon-alert"
					style="float: left; margin: 0 7px 20px 0;"></span> После нажатия
				кнопки "ДА" произойдет рассылка СМС по всем телефонам находящимся в
				таблице. </br>
...
<script type="text/javascript"
	src="controller/client/js/smscenter/smsbylist.js"></script>
<?php
} else {
