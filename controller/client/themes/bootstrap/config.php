	...
	<div class="row-fluid">
		...
		<form class="form-horizontal" role="form"
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="form_sitename" class="col-sm-2 control-label">URL
							сайта:</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="urlsite"
								id="urlsite" value="<?php echo $cfg->urlsite; ?>"
								placeholder="http://где_мой_сайт" size="80">
						</div>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						<label for="form_cfg_theme" class="col-sm-2 control-label">Текущая
							тема:</label>
						<div class="col-sm-2">
							<input type="text" class="form-control" name="form_cfg_theme"
								id="form_cfg_theme" readonly="readonly"
								value="<?php echo $cfg->theme; ?>">
						</div>
						<label for="form_cfg_theme_sl" class="col-sm-2 control-label">Выберите
							тему:</label>
						<div class="col-sm-6">
							<select class="form-control" name="form_cfg_theme_sl"
								id="form_cfg_theme_sl">
								<?php
        ...
        ?>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="col-sm-6">
						<label for="form_emailadmin" class="control-label">От кого почта
							(From):</label> <input type="text" class="form-control"
							name="form_emailadmin" id="form_emailadmin"
							value="<?php echo $cfg->emailadmin; ?>"> <label
							for="form_emailreplyto" class="control-label">Куда посылать
							ответы (Reply-To):</label> <input type="text"
							class="form-control" name="form_emailreplyto"
							id="form_emailreplyto" value="<?php echo $cfg->emailreplyto; ?>">
					</div>
				</div>
			</div>
			<div align="center">
				<button class="btn btn-primary" type="submit" name="Submit">Сохранить
					изменения</button>
			</div>
		</form>
	</div>
