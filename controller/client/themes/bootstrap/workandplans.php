...
{ // Возврат - массив планов завода
    ...
    if (file_exists('import/plans.xml')) {
        ...
        foreach ($xml->plans as $plans) {
            ...
            if ($res[$i]['nom'] == "") {
                $res[$i]['prpr'] = 100 - abs(round($res[$i]['protklplkol'] * 100 / $res[$i]['plprkol'], 2));
            }
            ;
			...
			<thead>
				<tr>
					...
					<th colspan="2" rowspan="1"
						style="vertical-align: top; text-align: center;">Выпуск ГП</th>
					<th colspan="2" rowspan="1"
						style="vertical-align: top; text-align: center;">План производства</th>
					<th colspan="2" rowspan="1"
						style="vertical-align: top; text-align: center;">Отклонение от
						плана</th>
					<th colspan="1" rowspan="2"
						style="vertical-align: top; text-align: center;">% выполнения</th>
					<th colspan="2" rowspan="1"
						style="vertical-align: top; text-align: center;">Отгружено</th>
				</tr>
				<tr>
...
for ($i = 0; $i < count($pl); $i ++) {
    ...
    if ($plprkol == 0) {
        ...
        $prpr = round($vpkol * 100 / $plprkol, 2);
    }
    ;
    ...
    if ($nm != "") {
        ...
        if ($plprkol_i == 0) {
            ...
            $prpr_i = round($vpkol_i * 100 / $plprkol_i, 2);
        }
        ;
