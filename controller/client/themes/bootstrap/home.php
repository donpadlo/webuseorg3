		...
		<div class="col-xs-12 col-md-8 col-sm-6">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<ul class="pager">
						<li class="previous"><a href="#" id="newsprev" name="newsprev">&larr;
								Назад</a></li>
						<li class="next"><a href="#" id="newsnext" name="newsnext">Вперед
								&rarr;</a></li>
					</ul>
    ...
    if ($stiker['title'] != '') :
        ?>
			...
			<?php if (($mhome->IsActive('commits-widget') == 1) && ($user->mode == 1)): ?>
				...
				<div class="panel-body">
					<iframe
						src="http://tylerlh.github.com/github-latest-commits-widget/?username=donpadlo&repo=webuseorg3&limit=5"
...
<?php if (($mhome->IsActive('lastmoved') == 1) && ($user->id != '') && ($cfg->useragent!="NOC-agent")): ?>
...
<!-- [/Последние перемещения ТМЦ] -->
<?php endif; ?>
<?php if (($mhome->IsActive('whoonline') == 1) && ($cfg->useragent!="NOC-agent")): ?>
<!-- [Кто онлайн] -->
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12 col-md-12 col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-firefox" aria-hidden="true"></i> Кто онлайн
				</div>
				<div class="panel-body">
...
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12 col-md-12 col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-mobile" aria-hidden="true"></i> Доступны для
					сообщений
				</div>
				<div class="panel-body">
