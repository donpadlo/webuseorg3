...
<head>
	...
	<link rel="stylesheet" href="controller/client/themes/<?php echo $cfg->theme; ?>/css/bootstrap-responsive.min.css">
...
echo "<link rel='stylesheet' href='controller/client/themes/$cfg->theme/css/demo.css'>";
...
echo "<script src='js/i18n/grid.locale-ru.js'></script>";    
echo "<script src='js/jquery.jqGrid.min.js'></script>";
...
echo "<script src='js/docsupport/prism.js' charset='utf-8'></script>";
?>
