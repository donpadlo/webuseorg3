...
if (isset($_GET["curuserid"]))   {$curuserid = $_GET['curuserid'];} else {$curuserid ="";};
if (isset($_GET["curplid"]))   {$curplid = $_GET['curplid'];} else     {$curplid ="";};
if (isset($_GET["curorgid"]))   {$curorgid = $_GET['curorgid'];} else   {$curorgid ="";};
if (isset($_GET["tpo"]))   {$tpo = $_GET['tpo'];} else         {$tpo ="";};
if (isset($_GET["os"]))   {$os = $_GET['os'];} else           {$os ="";};
if (isset($_GET["repair"]))   {$repair = $_GET['repair'];} else   {$repair ="";};
