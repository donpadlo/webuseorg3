...
if (isset($_POST["dgname"]))      {$dgname= $_POST['dgname'];}    else {$dgname="";};
if (isset($_POST["dcomment"]))      {$dcomment= $_POST['dcomment'];}    else {$dcomment="";};
...
if ($oper=='')
{
	...
	while($row = mysqli_fetch_array($result)) {
	    	...
	    	$responce->rows[$i]['cell']=array($row['id'],$row['dgname'],$row['dcomment']);		
                $i++;
	}
