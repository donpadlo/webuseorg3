...
if ($oper == '') {
        ...
        while ($row = mysqli_fetch_array($result)) {$groupid = $row["groupid"];};
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($cnt == 0) {
                ...
                if ($rs == '') {
                    die('Не смог добавить параметр!: ' . mysqli_error($sqlcn->idsqlconnection));
                }
            }
        }
};
...
if ($oper == 'edit') {
    ...
    if ($result == '') {
        die('Не смог изменить параметр!: ' . mysqli_error($sqlcn->idsqlconnection));
    }
}
...
if ($oper == 'del') {
 ...
 //   echo "!$sql!";
    ...
    if ($result == '') {
        die('Не смог удалить параметр!: ' . mysqli_error($sqlcn->idsqlconnection));
    }
}
