...
class SMSTowers
{
            ...
            switch ($xml->code) {
                case 1:
                    ...
                    foreach ($xml->xpath('//message') as $message) {
                        $result[] = array(
                            "phone" => (string) $message->phoneNumber,
                            "id" => (int) $message->idMessage
                        );
                    }
                    return $result;
                    break;
                ...
                case 1:
                    foreach ($xml->xpath('//message') as $message) {
                        $result[] = array(
                            ...
                            "datetime" => (string) $message->dateFinalStatus
                        );
                    }
                    return $result;
                    break;
    ...
    function GetLoginPassSMSTowerFromBase()
    {
        ...
        if ($result != '') {
            ...
            die('Неверный запрос SMSTower.GetLoginPassSMSTowerFromBase: ' . mysqli_error($sqlcn->idsqlconnection));
        }
