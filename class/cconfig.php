...
class Tcconfig
{
    ...
    function GetByParam($nameparam)
    {
         ...
         * }
         */
        $result = $sqlcn->ExecuteSQL("SELECT * FROM config_common WHERE nameparam='$nameparam'") or die('Неверный запрос Tcconfig.GetByParam: ' . mysqli_error($sqlcn->idsqlconnection));
    ...
    function SetByParam($nameparam, $valparam)
    {
        ...
        $result = $sqlcn->ExecuteSQL("UPDATE config_common SET valueparam='$valparam' WHERE nameparam='$nameparam'") or die('Неверный запрос Tcconfig.SetByParam: ' . mysqli_error($sqlcn->idsqlconnection));
    }
}
