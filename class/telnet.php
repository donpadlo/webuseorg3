...
class Telnet
{
    ...
    /**
     * Constructor.
     * Initialises host, port and timeout parameters
     ...
     * @param float $streamTimeout
     *            Stream timeout in decimal seconds
     * @return void
     */
     ...
     *
     * @param $strip boolean
     *            if the prompt should be stripped.
     * @return void
     */
